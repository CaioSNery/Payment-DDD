...
using PaymentContext.Shared.Shared;
...
namespace PaymentContext.Domain.Handlers
{
    ...
    IHandler<CreatePaypalSubscriptionCommand>, IHandler<CreateCreditCardSubscriptionCommand>
    {
        ...
        public ICommandResult Handle(CreateBoletoSubscriptionCommand command)
        {
            ...
            return new GenericCommandResult(true, "Assinatura Realizada com sucesso!", student);
        }

        public ICommandResult Handle(CreatePaypalSubscriptionCommand command)
        {
            if (_repository.DocumentExists(command.Document))
                AddNotification("Dodumento", "Cpf ja cadastrado");
        ...
        {
            if (_repository.DocumentExists(command.Document))
                AddNotification("Documento", "Cpf ja cadastrado");
            ...
            , command.Number, command.PaidDate, command.ExpireDate, command.Total, command.PaidTotal,
            address, command.Payer, new Document(command.PayerDocument, command.PayerDocumentType), email
            );
